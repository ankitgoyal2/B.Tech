...
public class notepad extends KeyAdapter implements ActionListener, KeyListener {
    ...
    JMenuItem newdoc, opendoc, exit, savedoc, saveasdoc, copydoc, pastedoc, remdoc, fontfamily, fontstyle, fontsize,
            status;
    JTextArea maintext;
    JTextField title;
    Font font1;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == newdoc) {
            ...
            if (title.getText().length() == 0) {
                topicstitle = JOptionPane.showInputDialog(null, "Enter Your File Title?", "Your File Name",
